  ...
  return (
    <div className="col-3">
      ...
      >
        ...
        />
        <div className=""></div>
        <div className="absolute bg-black-alpha-40 bottom-0 right-0 left-0 h-2rem flex justify-content-center align-items-center">
...
function SelectFood() {
  ...
  const [total, setTotal] = useState({ priceSale: 0, priceSell: 0 });
            ...
            <div className="border-top-2 border-200 mt-3">
              ...
              <div className="mt-4 flex justify-content-start">
                <Button
                  ...
                  onClick={() => navigator(config.router.listBill)}
                  raised
