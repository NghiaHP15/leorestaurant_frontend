...
export default function CreateGallery({ show, setShow, mutation }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const [resultGallery] = await Promise.all([
        CategoryGallery.listCategoryGallery(),
      ]);
      setCategoryGallery(resultGallery.data);
    };
    fetchData();
  }, []);
