...
export default function CreateBanner({ show, setShow, mutation }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const [resultBanner] = await Promise.all([
        CategoryBanner.listCategoryBanner(),
      ]);
      setCategoryBanner(resultBanner.data);
    };
    fetchData();
  }, []);
